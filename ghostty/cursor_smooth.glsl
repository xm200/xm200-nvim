...
// --- CONFIGURATION ---
vec4 TRAIL_COLOR = vec4(sRGBToLinear(vec3(1.0, 0.42, 0.0)), 0.72);
const float DURATION = 0.24; // total animation time
const float TRAIL_SIZE = 0.86; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
